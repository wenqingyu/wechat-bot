...
function onServerLogin(data, attempt = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            this.user = contact_1.Contact.load(this.userId);
...
function onServerMessage(obj) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            switch (m.type()) {
                case 37 /* VERIFYMSG */:
                    firer_1.Firer.checkFriendRequest.call(this, m);
                    break;
                case 10000 /* SYS */:
                    if (m.room()) {
                        firer_1.Firer.checkRoomJoin.call(this, m);
                        firer_1.Firer.checkRoomLeave.call(this, m);
                        firer_1.Firer.checkRoomTopic.call(this, m);
                    }
                    else {
                        firer_1.Firer.checkFriendConfirm.call(this, m);
                    }
                    break;
            }
            /**
