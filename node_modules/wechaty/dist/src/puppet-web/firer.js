...
function checkFriendRequest(m) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const request = new friend_request_1.FriendRequest();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (inviter === "You've" || inviter === '你' || inviter === 'your') {
                inviterContact = contact_1.Contact.load(this.userId);
            }
            const max = 20;
            const backoff = 300;
            ...
            yield retryPromise({ max: max, backoff: backoff }, (attempt) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i in inviteeList) {
                    const loaded = inviteeContactList[i] instanceof contact_1.Contact;
                    if (!loaded) {
                    ...
                    if (inviteeContactList[i] instanceof contact_1.Contact) {
            ...
            if (!inviteeContactList.every(c => c instanceof contact_1.Contact)) {
                ...
                inviteeContactList = inviteeContactList.filter(c => (c instanceof contact_1.Contact));
...
function checkRoomLeave(m) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!leaverContact) {
            config_1.log.error('PuppetWebFirer', 'fireRoomLeave() leaver %s not found, event `room-leave` & `leave` will not be fired');
            return;
        }
...
function checkRoomTopic(m) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (/^You$/.test(changer) || /^你$/.test(changer)) {
            changerContact = contact_1.Contact.load(this.userId);
        }
        else {
