...
ava_1.test('PuppetWebFriendRequest.receive smoking test', t => {
...
`;
    ...
    const fr = new friend_request_1.FriendRequest();
    ...
    t.true(fr.contact instanceof contact_1.Contact, 'should have a Contact instance');
    t.is(fr.type, 'receive', 'should be receive type');
});
ava_1.test('PuppetWebFriendRequest.confirm smoking test', t => {
    /* tslint:disable:max-line-length */
    const rawMessageData = `
