...
class IoClient {
    constructor(token = config_1.Config.token || config_1.Config.DEFAULT_TOKEN, log = new brolog_env_1.Brolog()) {
        this.token = token;
        this.log = log;
        this.state = new state_monitor_1.StateMonitor('IoClient', 'offline');
        if (!log) {
